...
#define DEV_SHELL_CFG_ECHO_ENABLED            DEV_ON
#define DEV_SHELL_CFG_PROMPT_ENABLED          DEV_ON
#define DEV_SHELL_CFG_CRLF_ENABLED            DEV_ON
#define DEV_SHELL_CFG_BACKSPACE_ENABLED       DEV_ON
#define DEV_SHELL_CFG_QUOTE_PARSE_ENABLED     DEV_ON
#define DEV_SHELL_CFG_RUNTIME_CHECK_ENABLED   DEV_ON
#define DEV_SHELL_CFG_RUNTIME_COMMAND_ENABLED DEV_ON
