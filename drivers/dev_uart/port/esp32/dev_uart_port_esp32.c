/* ESP32 UART port — PLACEHOLDER STUB. Returns DEV_ERR_NOT_SUPPORTED. */
#include "dev_uart_port_esp32.h"
#include "dev_common.h"

static const dev_uart_hw_t s_map[DEV_UART_CFG_MAX_INSTANCES] = {
    [DEV_UART_CONSOLE] = { DEV_UART_CONSOLE, 0, 1, 3, DEV_UART_BAUDRATE_115200, 256U, 256U },
};
